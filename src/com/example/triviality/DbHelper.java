...
public class DbHelper extends SQLiteOpenHelper {
	...
	private void addQuestions()
	{
		Question q1=new Question("Who created the TV show" +
				" The Sopranos ?","Martin Scorsese", "James Gandolfini", "David Chase", "David Chase");
		this.addQuestion(q1);
		Question q2=new Question("Where the majority of the exterior" +
				" scenes take place?", "New York", "New Jersey", "Sicilia", "New Jersey");
		this.addQuestion(q2);
		Question q3=new Question("Who played Dr.Melfi ?","Lorraine Bracco", "Nancy Marchand","Edie Falco","Lorraine Bracco");
		this.addQuestion(q3);
		Question q4=new Question("How many seasons" +
				" do we got?",	"6", "4", "8","6");
		this.addQuestion(q4);
		Question q5=new Question("When was the HBO premiere" +
				" of The Sopranos?","January 30, 2000","January 20, 1998","January 10, 1999","January 10, 1999");
		this.addQuestion(q5);
		Question q6=new Question("What is the name of" +
				" Artie's restaurant?","Vesuvio","Sicilia","Pompeii","Vesuvio");
		this.addQuestion(q6);
		Question q7=new Question("What is the real name" +
				" of 'Big Pussy' ?","Eugene Pontecorvo","Robert Baccalieri, Jr","Salvatore Bonpensiero","Salvatore Bonpensiero");
		this.addQuestion(q7);
		Question q8=new Question("Who is Tony Blundetto" +
				" played by Steve Buscemi ?","Tony Soprano's brother","Tony Soprano's cousin ","Tony Soprano's boss","Tony Soprano's cousin ");
		this.addQuestion(q8);
		Question q9=new Question("What's the favorite movie of" +
				" Ralphie Cifaretto ?","Gladiator","Alien","Blade Runner","Gladiator");
		this.addQuestion(q9);
		Question q10=new Question("Who killed Christopher Moltisanti," +
				" after a car accident ?","Adriana La Cerva","Tony Soprano","Phil Leotardo","Tony Soprano");
